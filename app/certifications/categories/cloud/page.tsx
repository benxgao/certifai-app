...
export default function CloudCertificationsPage() {
  ...
  return (
    <MarketingPageShell className="bg-linear-to-br from-slate-50 to-blue-50/30 dark:from-slate-900 dark:to-slate-800">
      <LandingHeader />
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="text-center mb-16 relative">
          ...
          <div className="relative z-10 py-16">
            <MarketingBadge className="mb-6 bg-blue-100 dark:bg-blue-900/30 border-blue-200 dark:border-blue-800/50 text-blue-700 dark:text-blue-300">
