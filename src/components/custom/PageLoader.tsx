...
const PageLoader: React.FC<PageLoaderProps> = ({
  ...
  const containerClasses = fullScreen
    ? 'fixed inset-0 z-50 grid place-items-center bg-linear-to-br from-slate-50 via-white to-violet-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-violet-950/20 relative overflow-hidden min-h-screen min-h-dvh'
    : 'grid place-items-center h-screen min-h-screen min-h-dvh w-full bg-linear-to-br from-slate-50/50 via-white/50 to-violet-50/20 dark:from-slate-950/50 dark:via-slate-900/50 dark:to-violet-950/10 relative overflow-hidden';
