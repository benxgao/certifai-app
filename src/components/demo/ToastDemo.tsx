    ...
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border border-slate-200/60 dark:border-slate-700/60 shadow-2xl rounded-xl p-6 space-y-4">
          ...
          <ActionButton onClick={handleConfirmToast} variant="outline" size="lg" className="w-full">
            Confirmation Dialog
          </ActionButton>

          <ActionButton onClick={handleComplexToast} variant="success" size="lg" className="w-full">
            Action Button Toast
          </ActionButton>
