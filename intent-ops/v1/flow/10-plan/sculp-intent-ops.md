...
| `intent-ops/v1/flow/10-plan/README.md`                                                                                                                    | Links to `../../docs/operations/spec-first-kanban-integration.md` — broken inside the package; must repoint to `../../spec/operations/spec-first-kanban-integration.md`.                                                                                                                                 |
...
| `ai_oriented_kanban/40-archive/26-05/260529-specs-first-kanban-integration.md` (repo root)  | Reference implementation for governance contract + closing phases in `v1/spec/operations/spec-first-kanban-integration.md`.                                                   |
...
| `intent-ops/v1/spec/operations/spec-first-kanban-integration.md`                                                                                        | Generalized spec-first governance contract + reviewer gates — referenced by `v1/flow/10-plan/README.md`.                                                                                                                                                                 |
...
| `intent-ops/v1/flow/10-plan/README.md`                     | Repoint `docs/operations/spec-first-kanban-integration.md` → `spec/operations/spec-first-kanban-integration.md`; audit other `docs/` refs.                                                                                                                                               |
...
| `intent-ops/v1/spec/operations/*` (smoke-tests, docs-maintenance, spec-first-kanban-integration, \_template) | QA + governance protocol layer.                          |
